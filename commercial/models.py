...
class ServiceRequest(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.service_requests"
...
class CapacityAssessment(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.capacity_assessments"
...
class Opportunity(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.opportunities"
...
class Quotation(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.quotations"
...
class QuotationItem(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.quotation_items"
...
class Agreement(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.agreements"
...
class AgreementTerm(CommercialBaseModel):
    ...
    class Meta:
        db_table = "commercial.agreement_terms"
